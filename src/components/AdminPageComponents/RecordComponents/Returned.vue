...
<script>
	import ViewDetails from "./ReturnedComponents/ViewDetails.vue";
	import DeleteRecord from "./ReturnedComponents/DeleteRecord.vue";
			...
			async getRecords() {
				try {
					...
					this.records = this.records.filter((record) => {
						return record.record_status == "Returned";
					});
